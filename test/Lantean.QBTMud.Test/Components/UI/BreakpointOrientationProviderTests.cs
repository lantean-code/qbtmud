...
namespace Lantean.QBTMud.Test.Components.UI
{
    ...
    {
        private static readonly Guid _testBrowserViewportId = new("20000000-0000-0000-0000-000000000001");
        ...
        private static BrowserViewportEventArgs CreateArgs(double width, double height, Breakpoint breakpoint)
        {
            ...
            return new BrowserViewportEventArgs(_testBrowserViewportId, size, breakpoint, false);
        }
