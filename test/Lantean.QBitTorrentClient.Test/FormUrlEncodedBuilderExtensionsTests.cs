...
namespace Lantean.QBitTorrentClient.Test
{
    public class FormUrlEncodedBuilderExtensionsTests
    {
        ...
        public async Task GIVEN_BoolTrue_WHEN_Add_THEN_ShouldSerializeAsTrue()
        {
            ...
            (await content.ReadAsStringAsync(TestContext.Current.CancellationToken)).Should().Be("flag=true");
        }
        ...
        public async Task GIVEN_BoolFalse_WHEN_Add_THEN_ShouldSerializeAsFalse()
        {
            ...
            using var content = _target.ToFormUrlEncodedContent();
            (await content.ReadAsStringAsync(TestContext.Current.CancellationToken)).Should().Be("flag=false");
        }
        ...
        public async Task GIVEN_Int_WHEN_Add_THEN_ShouldSerializeAsDigits()
        {
            ...
            using var content = _target.ToFormUrlEncodedContent();
            (await content.ReadAsStringAsync(TestContext.Current.CancellationToken)).Should().Be("count=123");
        }
        ...
        public async Task GIVEN_Long_WHEN_Add_THEN_ShouldSerializeAsDigits()
        {
            ...
            using var content = _target.ToFormUrlEncodedContent();
            (await content.ReadAsStringAsync(TestContext.Current.CancellationToken)).Should().Be("size=9223372036854775807");
        }
        ...
        public async Task GIVEN_DateTimeOffsetSeconds_WHEN_Add_THEN_ShouldUseUnixSeconds()
        {
            ...
            using var content = _target.ToFormUrlEncodedContent();
            (await content.ReadAsStringAsync(TestContext.Current.CancellationToken)).Should().Be("epoch=946684800");
        }
        ...
        public async Task GIVEN_DateTimeOffsetMilliseconds_WHEN_Add_THEN_ShouldUseUnixMilliseconds()
        {
            ...
            using var content = _target.ToFormUrlEncodedContent();
            (await content.ReadAsStringAsync(TestContext.Current.CancellationToken)).Should().Be("epochMs=946684800000");
        }
        ...
        public async Task GIVEN_Float_WHEN_Add_THEN_ShouldUseCurrentCultureToString()
        {
            ...
            using var content = _target.ToFormUrlEncodedContent();
            (await content.ReadAsStringAsync(TestContext.Current.CancellationToken)).Should().Be($"ratio={expected}");
        }
        ...
        public async Task GIVEN_GenericByte_WHEN_Add_Generic_THEN_ShouldSerializeAsInt32String()
        {
            ...
            using var content = _target.ToFormUrlEncodedContent();
            (await content.ReadAsStringAsync(TestContext.Current.CancellationToken)).Should().Be("b=7");
        }
        ...
        public async Task GIVEN_GenericEnum_WHEN_Add_Generic_THEN_ShouldSerializeUnderlyingInt32String()
        {
            ...
            using var content = _target.ToFormUrlEncodedContent();
            (await content.ReadAsStringAsync(TestContext.Current.CancellationToken)).Should().Be("day=5");
        }
        ...
        public async Task GIVEN_AllTrue_WHEN_AddAllOrPipeSeparated_THEN_ShouldUseAllLiteral()
        {
            ...
            using var content = _target.ToFormUrlEncodedContent();
            (await content.ReadAsStringAsync(TestContext.Current.CancellationToken)).Should().Be("list=all");
        }
        ...
        public async Task GIVEN_AllNullOrFalse_WHEN_AddAllOrPipeSeparated_THEN_ShouldJoinWithPipes()
        {
            ...
            using var content = _target.ToFormUrlEncodedContent();
            (await content.ReadAsStringAsync(TestContext.Current.CancellationToken)).Should().Be("list=a%7Cb+c%7Cd%7Ce");
        }
        ...
        public async Task GIVEN_PipeSeparatedValues_WHEN_AddPipeSeparated_THEN_ShouldJoinAndEncodeProperly()
        {
            ...
            using var content = _target.ToFormUrlEncodedContent();
            (await content.ReadAsStringAsync(TestContext.Current.CancellationToken)).Should().Be("ids=a%7Cb+c%7Cd%7Ce");
        }
        ...
        public async Task GIVEN_CommaSeparatedValues_WHEN_AddCommaSeparated_THEN_ShouldJoinAndEncodeProperly()
        {
            ...
            using var content = _target.ToFormUrlEncodedContent();
            (await content.ReadAsStringAsync(TestContext.Current.CancellationToken)).Should().Be("items=1%2C2%2C3");
        }
        ...
        public async Task GIVEN_MultipleAdds_WHEN_Chained_THEN_ShouldPreserveOrder()
        {
            ...
            using var content = _target.ToFormUrlEncodedContent();
            (await content.ReadAsStringAsync(TestContext.Current.CancellationToken)).Should().Be("flag=true&count=2&epoch=946684800&b=7");
        }
    }
}
